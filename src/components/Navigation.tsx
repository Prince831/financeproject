    ...
    <nav className={`${darkMode ? 'bg-slate-900/95 backdrop-blur-sm border-slate-700' : 'bg-white/95 backdrop-blur-sm border-slate-200'} border-b shadow-lg sticky top-0 z-40`}>
      <div className="w-full px-6 lg:px-8 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          <div className={`flex items-center gap-2 px-4 py-2 rounded-lg border shadow-sm transition-all duration-200 ${darkMode ? 'bg-slate-800 border-slate-700 text-slate-200 hover:bg-slate-700' : 'bg-white border-slate-200 text-slate-700 hover:bg-slate-50'} hover:shadow-md`}>
          ...
          <button onClick={() => setShowHistory(!showHistory)} className={`flex items-center gap-2 px-4 py-2 text-sm rounded-lg border shadow-sm transition-all duration-200 ${darkMode ? 'bg-slate-800 border-slate-700 text-slate-200 hover:bg-slate-700' : 'bg-white border-slate-200 text-slate-700 hover:bg-slate-50'} hover:shadow-md`}>
            <Clock className="w-4 h-4 text-slate-500" /><span className="font-medium hidden sm:inline">History</span>
          </button>
          <button onClick={toggleDarkMode} className={`flex items-center gap-2 px-4 py-2 text-sm rounded-lg border shadow-sm transition-all duration-200 ${darkMode ? 'bg-slate-800 border-slate-700 text-slate-200 hover:bg-slate-700' : 'bg-white border-slate-200 text-slate-700 hover:bg-slate-50'} hover:shadow-md`}>
